...
import { Calendar, Users, FileText, Award, Clock, MapPin, Star, ChevronRight } from 'lucide-react';
...
const HomePage = () => {
  ...
  const stats = [
    { label: 'Bài báo đã nhận', value: '1,247', icon: FileText, color: 'bg-blue-500' },
    { label: 'Tác giả tham gia', value: '892', icon: Users, color: 'bg-green-500' },
    { label: 'Phản biện viên', value: '156', icon: Star, color: 'bg-purple-500' },
    { label: 'Ngày còn lại', value: '45', icon: Clock, color: 'bg-red-500' }
  ];

  const timeline = [
    { date: '15/12/2024', title: 'Hạn cuối nộp bài', status: 'completed' },
    { date: '20/01/2025', title: 'Thông báo kết quả phản biện', status: 'active' },
  ...
  const news = [
    {
      ...
      excerpt: 'Do nhiều yêu cầu từ cộng đồng nghiên cứu, ban tổ chức quyết định gia hạn thời gian nộp bài...',
      date: '10/12/2024',
    ...
    },
    {
      ...
      excerpt: 'Chúng tôi vinh dự giới thiệu các chuyên gia hàng đầu sẽ tham gia hội nghị năm nay...',
      date: '05/12/2024',
      category: 'Tin tức'
    },
    {
      ...
      excerpt: 'Template mới đã được cập nhật với các yêu cầu về định dạng và cấu trúc bài báo...',
      date: '01/12/2024',
      category: 'Hướng dẫn'
    }
  ];
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Nền tảng hàng đầu kết nối các nhà nghiên cứu, chia sẻ kiến thức và thúc đẩy 
            sự đổi mới trong lĩnh vực công nghệ thông tin và khoa học máy tính.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="flex items-center justify-center space-x-3">
              ...
              <span className="text-gray-700 font-medium">1-3 Tháng 3, 2025</span>
            </div>
            <div className="flex items-center justify-center space-x-3">
              <MapPin className="w-6 h-6 text-blue-600" />
              <span className="text-gray-700 font-medium">TP. Hồ Chí Minh, Việt Nam</span>
            </div>
            <div className="flex items-center justify-center space-x-3">
              <Users className="w-6 h-6 text-blue-600" />
              <span className="text-gray-700 font-medium">1000+ Tham dự viên</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Lịch trình quan trọng</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Theo dõi các mốc thời gian quan trọng để không bỏ lỡ cơ hội tham gia hội nghị
            </p>
          </div>
              ...
              {timeline.map((item, index) => (
                <div key={index} className="relative flex items-center">
                  ...
                  <div className={`relative z-10 w-4 h-4 rounded-full border-4 ${
                    ...
                    item.status === 'active' ? 'bg-blue-500 border-blue-200' :
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Gặp gỡ các chuyên gia hàng đầu sẽ chia sẻ những nghiên cứu tiên phong
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-12">
            <div>
              ...
              <p className="text-gray-600">Cập nhật thông tin mới nhất về hội nghị</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {news.map((article) => (
              <article key={article.id} className="bg-white rounded-2xl p-6 border border-gray-100 hover:shadow-lg transition-shadow duration-300 cursor-pointer group">
                <div className="flex items-center justify-between mb-4">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Đăng ký ngay hôm nay để không bỏ lỡ cơ hội kết nối với cộng đồng nghiên cứu hàng đầu
          </p>
